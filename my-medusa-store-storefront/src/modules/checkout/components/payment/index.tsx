      ...
      <div>
        <div className={isOpen ? "block" : "hidden"}>
          {!paidByGiftcard && cart?.payment_sessions?.length ? (
            <>
              {/* Removed radio group for displaying payment methods, as stripe payment element will handle this */}
              {/*
              <RadioGroup
              ...
              */}
              {isStripe && stripeReady && (
                <div className="mt-5 transition-all duration-150 ease-in-out">
                  ...
                  />
                  {/* Removed card element - CheckoutForm component will display the stripe PaymentElement */}
                  {/*
                  <CardElement
...
// Added CheckoutForm - the component receives an onChangeHandler just like the CardElement did
...
const CheckoutForm: FC<CheckoutFormProps> = ({ onChange }) => {
